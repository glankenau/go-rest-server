...
func (ts *taskServer) createTaskHandler(w http.ResponseWriter, req *http.Request) {
	log.Printf("handling task create at %s/n", req.URL.Path)
...
func (ts *taskServer) getAllTasksHanlder(w http.ResponseWriter, req *http.Request) {
	log.Printf("handling get all tasks at %s/n", req.URL.Path)
...
func (ts *taskServer) deleteTaskHandler(w http.ResponseWriter, req *http.Request) {
	log.Printf("hanlding delete task at %s/n", req.URL.Path)
...
func (ts *taskServer) deleteAllTasksHandler(w http.ResponseWriter, req *http.Request) {
	log.Printf("handling delete all tasks %s/n", req.URL.Path)
	ts.store.DeleteAllTasks()
}

func (ts *taskServer) tagHandler(w http.ResponseWriter, req *http.Request) {
	log.Printf("handling tasks by tag at %s/n", req.URL.Path)
...
func (ts *taskServer) dueHandler(w http.ResponseWriter, req *http.Request) {
	log.Printf("handling tasks by due date at %s/n", req.URL.Path)
...
func main() {
	...
	mux.HandleFunc("GET /task/", server.getAllTasksHanlder)
