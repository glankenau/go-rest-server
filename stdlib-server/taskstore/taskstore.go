...
// TaskStore is a simple in-memory database of tasks; TaskStore methods
...
// DeleteAllTasks deletes the tasks in the store
...
// GetTasksByTag returns all the tasks that have the given tag, in
// arbitrary order
